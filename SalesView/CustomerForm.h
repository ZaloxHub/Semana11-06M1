...
namespace SalesView {
	...
	public:
		CustomerForm(void)
		{
			...
			//
			/*
			myThread = gcnew Thread(gcnew ThreadStart(this, &CustomerForm::MyRun));
			myThread->Start();
			*/
		}
		/*
		void MyRun() {
			...
			while (true) {
				if (this == nullptr || !this->Visible)
					return;
				//	RefreshPersonsDGV();
				//RefreshCompaniesDGV();
				Invoke(gcnew delegateRefreshCustomers(this, &CustomerForm::RefreshPersonsDGV));
				time = rnd->Next() % 10 + 5;
				Thread::Sleep(time * 1000);
			}
		}		
		delegate void delegateRefreshCustomers();
		*/
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabCustomers->Size = System::Drawing::Size(460, 441);
			...
			this->tabPage1->Size = System::Drawing::Size(452, 415);
			...
			// btnDeletePerson
			// 
			this->btnDeletePerson->Location = System::Drawing::Point(291, 212);
			...
			// btnUpdatePerson
			// 
			this->btnUpdatePerson->Location = System::Drawing::Point(164, 212);
			...
			this->btnAddPerson->Location = System::Drawing::Point(31, 212);
			...
			this->dgvPersons->Size = System::Drawing::Size(422, 157);
			...
			// txtAddress
			// 
			this->txtAddress->Location = System::Drawing::Point(121, 117);
			this->txtAddress->Multiline = true;
			this->txtAddress->Name = L"txtAddress";
			this->txtAddress->Size = System::Drawing::Size(269, 35);
			...
			this->txtPersonId->Size = System::Drawing::Size(59, 20);
			this->txtPersonId->TabIndex = 5;
			// 
			// txtDNI
			// 
			this->txtDNI->Location = System::Drawing::Point(289, 9);
			...
			// txtLastName
			// 
			this->txtLastName->Location = System::Drawing::Point(121, 63);
			...
			// txtFirstName
			// 
			this->txtFirstName->Location = System::Drawing::Point(121, 36);
			...
			this->label2->Location = System::Drawing::Point(228, 12);
			...
			this->tabPage2->Size = System::Drawing::Size(452, 415);
			...
			// txtCompanyEmail
			// 
			this->txtCompanyEmail->Location = System::Drawing::Point(114, 152);
			this->txtCompanyEmail->Name = L"txtCompanyEmail";
			this->txtCompanyEmail->Size = System::Drawing::Size(291, 20);
			this->txtCompanyEmail->TabIndex = 19;
			// 
			// label16
			// 
			this->label16->AutoSize = true;
			this->label16->Location = System::Drawing::Point(27, 155);
			...
			this->dgvCompanies->Location = System::Drawing::Point(19, 216);
			this->dgvCompanies->Name = L"dgvCompanies";
			this->dgvCompanies->Size = System::Drawing::Size(411, 182);
			...
			// btnDeleteCompany
			// 
			this->btnDeleteCompany->Location = System::Drawing::Point(283, 183);
			...
			// btnUpdateCompany
			// 
			this->btnUpdateCompany->Location = System::Drawing::Point(160, 183);
			...
			this->btnAddCompany->Location = System::Drawing::Point(30, 183);
			...
			// txtLegalDepartment
			// 
			this->txtLegalDepartment->Location = System::Drawing::Point(288, 123);
			this->txtLegalDepartment->Name = L"txtLegalDepartment";
			this->txtLegalDepartment->Size = System::Drawing::Size(117, 20);
			this->txtLegalDepartment->TabIndex = 13;
			// 
			// label15
			// 
			this->label15->AutoSize = true;
			this->label15->Location = System::Drawing::Point(209, 127);
			...
			// 
			this->txtCompanyPhoneNumber->Location = System::Drawing::Point(114, 124);
			...
			// txtWebPage
			// 
			this->txtWebPage->Location = System::Drawing::Point(114, 97);
			this->txtWebPage->Name = L"txtWebPage";
			this->txtWebPage->Size = System::Drawing::Size(291, 20);
			this->txtWebPage->TabIndex = 10;
			// 
			// label14
			// 
			this->label14->AutoSize = true;
			this->label14->Location = System::Drawing::Point(27, 127);
			...
			// txtCompanyAddress
			// 
			this->txtCompanyAddress->Location = System::Drawing::Point(114, 70);
			this->txtCompanyAddress->Name = L"txtCompanyAddress";
			this->txtCompanyAddress->Size = System::Drawing::Size(291, 20);
			this->txtCompanyAddress->TabIndex = 7;
			// 
			// label12
			// 
			this->label12->AutoSize = true;
			this->label12->Location = System::Drawing::Point(27, 73);
			...
			// txtCompanyName
			// 
			this->txtCompanyName->Location = System::Drawing::Point(114, 44);
			this->txtCompanyName->Name = L"txtCompanyName";
			this->txtCompanyName->Size = System::Drawing::Size(291, 20);
			this->txtCompanyName->TabIndex = 5;
			// 
			// label11
			// 
			this->label11->AutoSize = true;
			this->label11->Location = System::Drawing::Point(27, 47);
			...
			// txtRUC
			// 
			this->txtRUC->Location = System::Drawing::Point(295, 18);
			this->txtRUC->Name = L"txtRUC";
			this->txtRUC->Size = System::Drawing::Size(110, 20);
			this->txtRUC->TabIndex = 3;
			// 
			// txtCompanyId
			// 
			this->txtCompanyId->Location = System::Drawing::Point(114, 18);
			...
			this->label10->Location = System::Drawing::Point(234, 21);
			...
			this->label9->Location = System::Drawing::Point(27, 21);
...
private: System::Void btnAddPerson_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		*/
		p = gcnew Person(Int32::Parse(txtPersonId->Text), txtFirstName->Text, txtLastName->Text, 
		...
		MessageBox::Show("No se puede registrar el cliente por error en los datos.");
		return;
	}
...
private: System::Void btnUpdatePerson_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		MessageBox::Show("No se puede actualizar el cliente por error en los datos.");
		return;
	}
...
private: System::Void dgvPersons_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	if (dgvPersons->CurrentCell != nullptr &&
		...
		if (customer != nullptr && customer->GetType() == Person::typeid) {
			...
			txtDNI->Text = dynamic_cast<Person^>(customer)->Dni;
...
private: System::Void btnDeletePerson_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		MessageBox::Show("No se puede eliminar el cliente porque el Id no es válido.");
		return;
	}
...
private: System::Void btnAddCompany_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		*/
		p->Id = 1; // Int32::Parse(txtCompanyId->Text);
		...
		p->LegalDeparment = txtLegalDepartment->Text;
...
private: System::Void dgvCompanies_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) {
	if (dgvCompanies->CurrentCell != nullptr &&
		...
		if (customer->GetType() == Company::typeid) {
			...
			txtRUC->Text = dynamic_cast<Company^>(customer)->Ruc;
			txtLegalDepartment->Text = dynamic_cast<Company^>(customer)->LegalDeparment;
